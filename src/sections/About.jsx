  ...
  return (
    ...
    >
      <header className="flex flex-col items-center tablet:items-start">
        ...
        <hr className="border-t-2 border-slate-900 my-1 w-48" />
        <p className="font-poppinsBold text-lg text-sky-400">what I can do?</p>
      </header>

      <figure className="flex flex-col-reverse tablet:flex-row items-center justify-center tablet:space-x-5 bg-slate-900/5 p-10 tablet:p-12 rounded-lg shadow-md">
        <div className="flex flex-col justify-between space-y-4 bg-sky-100 p-3 shadow-lg rounded-lg">
          ...
          <div
            className={`flex items-center justify-start space-x-3 text-sky-400`}
          >
            <a
              href="#contact"
      ...
      <div className="flex flex-col space-y-5 bg-slate-900/5 px-10 tablet:px-12 pt-8 tablet:pt-10 pb-10 tablet:pb-12 rounded-lg shadow-md">
          ...
          <div className="flex flex-col items-center bg-sky-100 shadow-lg rounded-lg tablet:w-[50%] space-y-7 p-3">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="flex flex-col tablet:hover:bg-slate-300/60 items-center p-5 rounded-md">
                ...
                <p className="font-poppinsRegular tracking-wider text-sm">
                  MONGODB
                </p>
              </div>
