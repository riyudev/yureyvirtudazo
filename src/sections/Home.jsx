  ...
  return (
    <section id="home" 
      ...
      <div className="w-full min-h-full tablet:min-h-96 flex flex-col justify-center items-center tablet:items-start">
        ...
        <h1 className={`text-4xl/[45px] tablet:text-5xl/[60px] font-montserratExtraBold mt-3 mb-8 tablet:mb-16 tracking-wide text-dark-blue text-center tablet:text-start ${h1Animation}`} 
            style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0.2)' }}>
          <span className="text-sky-400">Develop</span> and <span className="text-sky-400">Design</span> things for the web.
        </h1>
