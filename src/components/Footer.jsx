    ...
    <footer className="flex justify-center w-full border-t-2 mt-10">
      <div className="flex flex-col gap-y-1 items-center pt-3 pb-4 max-w-7xl w-full">
        ...
        <div className="flex items-center space-x-3 text-sky-400">
          ...
          <a href="https://www.linkedin.com/in/yurey-virtudazo-3bba2a284/" target='_blank'>
        ...
        <h2 className="font-montserratBold text-sm">Designed and Built by: Yurey Virtudazo</h2>

        <h2 className="font-montserratBold text-sm">Copyright &copy; 2024 - All rights reserve</h2>
      </div>
    </footer>
  )
}
